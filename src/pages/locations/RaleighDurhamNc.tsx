...
const RaleighDurhamNc = () => (
  <>
    <SEOHead
      ...
      description="Contractor classification in RTP, first hires at university spin-outs, and public-contract wage rules — fixed-price HR audits for Triangle firms from $2,500."
