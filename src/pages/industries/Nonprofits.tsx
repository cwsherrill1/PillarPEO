...
const Nonprofits = () => (
  <>
    <SEOHead
      ...
      description="Volunteers versus employees, exempt status for program staff, grant-funded position documentation, and board and executive compensation. Fixed-price HR audits from $2,500."
