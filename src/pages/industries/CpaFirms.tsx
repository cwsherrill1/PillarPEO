...
const CpaFirms = () => (
  <>
    <SEOHead
      ...
      description="Busy-season overtime, why comp time is not available to private employers, seasonal staffing, per-diem and travel pay, and out-of-state staff. Fixed-price HR audits from $2,500."
