...
const Transitions = () => (
  <>
    <SEOHead
      ...
      description="Fixed-price transitions for firms moving into, out of or between a PEO, plus HRIS migrations and payroll switches. $3,000–$10,000, quoted before the work starts."
