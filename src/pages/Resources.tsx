...
const resources = [
  ...
  {
    icon: Scale,
    title: "State Employer Guides: North Carolina & South Carolina",
    desc: "HR rules organised by headcount, so you can see what applies at your size. NC and SC today; more states as we verify them.",
    category: "Guide",
    href: "/resources/state-employer-guides",
  },
  {
    icon: Scale,
    title: "NC vs. SC Employment Law: Side by Side",
    desc: "The comparison table for firms with staff in both Carolinas.",
    category: "Comparison",
    href: "/resources/nc-vs-sc-employment-law",
  },
  {
    icon: ClipboardCheck,
    title: "HR Audit Checklist",
    desc: "The nine areas we check and what sits under each one. Free, ungated, downloadable.",
    category: "Checklist",
    href: "/resources/hr-audit-checklist",
  },
  {
    icon: ClipboardCheck,
  ...
  {
    icon: FileText,
    title: "Is E-Verify Mandatory in North Carolina?",
    desc: "Yes, at 25 or more employees, under NCGS 64-26. What that means in practice.",
    category: "Guide",
    href: "/resources/e-verify-north-carolina",
  },
  {
    icon: FileText,
    title: "Is E-Verify Mandatory in South Carolina?",
    desc: "Yes, for all employers, within three business days of hire. What that means in practice.",
    category: "Guide",
    href: "/resources/e-verify-south-carolina",
  },
  {
    icon: BookOpen,
    title: "North Carolina Handbook Requirements",
    desc: "What an NC employee handbook should cover, section by section.",
    category: "Checklist",
    href: "/resources/nc-handbook-requirements",
  },
  {
    icon: BookOpen,
    title: "South Carolina Handbook Requirements",
    desc: "What an SC handbook should cover, including the at-will disclaimer language.",
    category: "Checklist",
    href: "/resources/sc-handbook-requirements",
  },
  {
    icon: HelpCircle,
    title: "Do We Need a PEO?",
    desc: "The readiness self-assessment and an honest answer about when a PEO fits and when it doesn't.",
