...
const faqs = [
  ...
  { q: "Do brokers represent every PEO?", a: "No broker has every PEO. Most independent brokers (including Pillar) work with 15–30 vetted PEOs covering the relevant market segments. Avoid 'brokers' who only represent one PEO — they're functionally a sales rep." },
