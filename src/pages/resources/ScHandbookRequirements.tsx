...
const ScHandbookRequirements = () => (
  <>
    ...
    <ServiceCta
      heading="Not sure your at-will language holds up?"
      body="The HR audit reviews your handbook language against how the company operates and where its exposure is."
