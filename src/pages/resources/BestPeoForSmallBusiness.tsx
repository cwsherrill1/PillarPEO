...
const providers = [
  ...
  { name: "Insperity", fit: "20–250 employees, white-collar firms, growth-stage", strengths: "High-touch service model, strong HR consulting, premium training/development", watchouts: "Premium pricing, contracts can be sticky at renewal", price: "$150–$200 PEPM" },
...
const faqs = [
  ...
  { q: "Are PEOs only for tech startups?", a: "No. PEOs serve construction, manufacturing, nonprofits, office-based firms, healthcare, restaurants, and most other industries. Workers' comp pooling is most valuable for higher-risk industries: they often see the biggest cost savings vs. buying coverage independently." },
