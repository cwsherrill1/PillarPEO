...
export const siteRoutes: SiteRoute[] = [
  ...
  { path: "/services/peo-brokerage", lastmod: "2026-09-05", changefreq: "monthly" },
  { path: "/services/transitions", lastmod: "2026-09-05", changefreq: "monthly" },
  ...
  { path: "/services/transitions", lastmod: "2026-09-05" },
